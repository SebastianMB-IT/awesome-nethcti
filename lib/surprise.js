...
function fantasma () {
  ...
  // type 'fantasma' on your keyboard
  var key = [70,65,78,84,65,83,77,65];
  var ck = 0;
  var max = key.length;
...
function pistola () {
  ...
  // type 'pistola' on your keyboard
  let key = [80,73,83,84,79,76,65]
  let ck = 0
  let max = key.length

  let pistola = function () {
...
function dolce () {
  ...
  // type 'dolce' on your keyboard
  var key = [68,79,76,67,69];
  var ck = 0;
  var max = key.length;
...
function soldi () {
  ...
  // type 'soldi' on your keyboard
  var key = [83,79,76,68,73];
  // var key = [65]
  var ck = 0;
  var max = key.length;
  ...
  var record = function(e) {
    ...
    if ( ck >= max ) {
      var audioInit = "SUQzBAAAAAABE1RYWFgAAAASAAADbWFqb3JfYnJhbmQAZGFzaABUWFhYAAAAEQAAA21pbm9yX3Zl"
        ...
        +"ViYt0nHJ/7EgSdnChRiUhAAAMAAOSjJGSf///zz//MAPAtortaWIAKg8MFgVB4wqLAMyt5+Q/8v7T6"
        ...
        +"gBCGBqFQgRYAG7DsBhweAYVIIAwiDCoyRETY83NAACAAUA/jkDDOIcaniBCyanEPUIWZInmj2wfiG"
...
function veloce () {
  ...
  // type 'veloce' on your keyboard
  let key = [86,69,76,79,67,69]
  // let key = [83]
  let ck = 0
  let max = key.length
...
function felice () {
  ...
  // type 'felice' on your keyboard
  var key = [70,69,76,73,67,69];
  // var key = [65]
  var ck = 0;
  var max = key.length;
...
function scappo () {
  ...
  // type 'scappo' on your keyboard
  let key = [83,67,65,80,80,79]
  let ck = 0
  let max = key.length
...
function bird () {
  ...
  let data = 'https://weichiachang.github.io/easter-eggs-mobile/images/saltaing-bird.gif'
...
function arrivo () {
  ...
  // type 'arrivo' on your keyboard
  var key = [65,82,82,73,86,79];
  var ck = 0;
  var max = key.length;
...
function battimani () {
  ...
  // type 'battimani' on your keyboard
  var key = [66,65,84,84,73,77,65,78,73];
  var ck = 0;
  var max = key.length;

  var battimani = function() {
...
function vieni () {
  ...
  // type 'vieni' on your keyboard
  var key = [86,73,69,78,73];
  var ck = 0;
  var max = key.length;
...
function calma () {
  ...
  // type 'calma' on your keyboard
  var key = [67,65,76,77,65];
  var ck = 0;
  var max = key.length;
...
function drago () {
  ...
  // type 'drago' on your keyboard
  let key = [68,82,65,71,79]
  let ck = 0
  let max = key.length
...
function porco () {
  ...
  // type 'porco' on your keyboard
  let key = [80,79,82,67,79]
  // let key = [67]
  let ck = 0
  let max = key.length
...
function salta () {
  ...
  // type 'salta' on your keyboard
  var key = [83,65,76,84,65];
  var ck = 0;
  var max = key.length;
...
function carro () {
  ...
  // type 'carro' on your keyboard
  var key = [67,65,82,82,79];
  var ck = 0;
  var max = key.length;
...
function vinto () {
  ...
  // type 'vinto' on your keyboard
  var key = [86,73,78,84,79];
  var ck = 0;
  var max = key.length;
...
function bello () {
  ...
  // type 'bello' on your keyboard
  let key = [66,69,76,76,79]
  let ck = 0
  let max = key.length
...
function nuoto () {
  ...
  // type 'nuoto' on your keyboard
  let key = [78,85,79,84,79]
  let ck = 0
  let max = key.length
...
function grazie () {
  "use strict";
  // type 'grazie' on your keyboard
  var key = [71,82,65,90,73,69];
  var ck = 0;
  var max = key.length;
...
function terra () {
  ...
  // type 'terra' on your keyboard
  let key = [84,69,82,82,65]
  let ck = 0
  let max = key.length
...
function fattimiei () {
  ...
  // type 'fattimiei' on your keyboard
  let key = [70,65,84,84,73,77,73,69,73]
  let ck = 0
  let max = key.length

  let fattimiei = function () {
...
function torta () {
  ...
  // type 'torta' on your keyboard
  var key = [84,79,82,84,65];
  var ck = 0;
  var max = key.length;
...
function dance () {
  ...
  // type 'dance' on your keyboard
  var key = [68,65,78,67,69];
  var ck = 0;
  var max = key.length;
...
function viaggio () {
  ...
  // type 'viaggio' on your keyboard
  let key = [86,73,65,71,71,73,79]
  let ck = 0
  let max = key.length

  let viaggio = function () {
...
function nethesis () {
  "use strict";
    ...
    // type 'nethesis' on your keyboard
    var key = [78,69,84,72,69,83,73,83];
    var ck = 0;
    var max = key.length;

    var nethesis = function() {
    ...
    var data = "https://nethservice.nethesis.it/nextcloud/index.php/s/dmxJ2WZ9AjAScxB/preview"
